...
export default function DashboardPage() {
  ...
  async function handleAIAnalysis() {
    try {
      ...
      /*
      * These analysis fields are temporary compatibility values.
      *
      * The backend no longer uses them to make the live AI decision.
      * Real market intelligence is generated by the backend from
      * MT5 data, technical analysis, market structure, MTF,
      * session analysis, and news analysis.
      */
      const aiData:
        AITradeAnalysisData = {
        symbol,
            ...
            <section id="ai-analysis-result" className="mt-8 overflow-hidden rounded-2xl border border-white/10 bg-[#0a0e13]">
              ...
              <div className="border-t border-white/10 px-5 py-5">
                ...
                <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <span className="shrink-0 text-xs font-semibold text-gray-500">Confidence {formatNumber(aiAnalysis.decision.decision_confidence, 1)}%</span>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 px-5 py-5">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  <AIMetricCard
                    ...
                    value={`${formatNumber(
                      aiAnalysis.decision.market_confidence,
                      1,
                    )}%`}
                  />
                  ...
                  <AIMetricCard
                    ...
                    value={`${formatNumber(
                      aiAnalysis.decision.decision_confidence,
                      1,
                    )}%`}
                  />
                </div>
              ...
              <div className="border-t border-white/10 px-5 py-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  <div>
                    ...
                    <p className="mt-1 max-w-2xl text-xs leading-5 text-gray-600">
                      Execute the analyzed trade only when the Decision Gate,
                      Risk Gate, risk validation, and approval layers all pass.
                    </p>
                  </div>
